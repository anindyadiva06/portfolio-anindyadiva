...
const PortoSection = ({ portoTab, setPortoTab }) => {
  ...
  const allProjects = [
    ...
    },
    {
      ...
      description: "This study compares Naive Bayes with SMOTE and SVM with Hyperparameter Tuning for sentiment analysis of Indonesia's 2024 presidential election on Twitter, finding Naive Bayes with SMOTE achieves superior accuracy (91.69%) by effectively handling class imbalance.",
